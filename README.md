...
In addition to the [godoc API documentation](http://godoc.org/github.com/acoshift/sqlx),
...
## install
    ...
    go get github.com/acoshift/sqlx
...
[sqlx_test.go](https://github.com/acoshift/sqlx/blob/master/sqlx_test.go) for more
usage.
